...
```bash
git clone https://github.com/<your-user>/terminal-eleven
cd terminal-eleven
...
The 72 group-stage fixtures and their ESPN event IDs are checked into the repo (`static_data/fixtures/group_stage.csv`), so everything except the live view works fully offline.
